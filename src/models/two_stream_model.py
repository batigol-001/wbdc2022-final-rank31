...
class TwoStreamModel(nn.Module):
    def __init__(self, args, pretrain=False, finetune=True):
        ...
        if self.is_pretrain:
            ...
            self.video_encoder_m = VisualFeatEncoder(bert_cfg, args.frame_embedding_size)
